...
el.data('pending',true);el.load('controller.php?obj=rs_ctrl&method=getAll&param[]='+tb+'&param[]='+id+'&param[]='+context,function(){el.data('done',true);el.data('pending',false);if(context=='read'){el.find('div.rsEl').on('click',function(){api.record.read(tb,[$(this).text()],true);});}
