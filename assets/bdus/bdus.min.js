...
* @since			15/apr/2012
*/
var core={runMod:function(o,t,n){var e;(t?"string"==typeof t&&(t=[t]):t=[],"object"!=typeof window[o]||debugMode)?(e=debugMode?"./modules/"+o+"/"+o+".js":"./modules/"+o+"/"+o+".min.js",console.log(e),$.ajax({url:e,dataType:"script",suppressErrors:!0,success:function(e){window[o].init.apply(null,t),n&&n()},error:function(t,n,e){core.open({obj:o,method:"read",title:core.tr(o)})}})):window[o].init.apply(null,t)},loading:'<img src="./assets/bdus/img/loader.gif"  alt="loading..." />',_get2url:function(o){return"string"==typeof o?o:$.isPlainObject(o)?$.param(o):!!$.isArray(o)&&"param[]="+o.join("&param[]=")},getHTML:function(o,t,n,e,r){var s="./?obj="+o+"&method="+t+(n?"&"+this._get2url(n):"");e?$.post(s,e,r):$.get(s,r)},getJSON:function(o,t,n,e,r){var s="./?obj="+o+"&method="+t+(n?"&"+this._get2url(n):"");e?$.post(s,e,r,"json"):$.get(s,r,"json")},runAndRespond(o,t,n,e,r){"function"==typeof n&&(r=n,n=!1,e=!1),"function"==typeof e&&(r=e,e=!1),core.getJSON(o,t,n,e,(o=>{core.message(o.text,o.status),r&&r(o)}))},open:function(o,t){"modal"===t?layout.dialog.add(o):layout.tabs.add(o)},tr:function(o,t){return lang[o]?t?vsprintf(lang[o],t):lang[o]:o},message:function(o,t,n){t||(t="info"),"info"===t||"success"===t||"warning"===t||"error"===t?iziToast[t]({message:o,maxWidth:"400px"}):alert(o)}};
/**
 * @author      Julian Bogdani <jbogdani@gmail.com>
 * @copyright    BraDypUS, Julian Bogdani <jbogdani@gmail.com>
 * @license      See file LICENSE distributed with this code
