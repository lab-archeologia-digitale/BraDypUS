...
const keepAlive={ms:18e4,interval:{},start(){this.interval=setInterval(this._keepAlive,this.ms)},stop(){clearInterval(this.interval)},_keepAlive:()=>{core.getJSON("keepAlive_ctrl","run",!1,!1,(e=>{"success"!==e.type&&(console.log(e.text),this.stop())}))}};